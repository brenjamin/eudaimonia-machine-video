...
export const Scene3EudaimoniaMachine: React.FC = () => {
	...
	return (
		<>
			<AbsoluteFill style={{backgroundColor: 'var(--yellow)'}}>
				<div
					style={{height: '100%', transform: `translateY(${slideProgress}%)`}}
				>
					<div
						style={{
							display: 'flex',
					...
					>
						<Title style={{opacity: opacity1}}>Eudaimonia</Title>
						<Title style={{opacity: opacity2}}>Machine</Title>
					</div>
					<svg
						version="1.1"
						id="Capa_1"
			...
			C322.833,129.881,319.252,126.299,314.833,126.299z"
				...
				>
					<Title style={{fontSize: '300px'}}>
						<span style={{opacity: opacity3}}>Eu</span>
						<span style={{opacity: opacity4}}>dai</span>
						<span style={{opacity: opacity5}}>mon</span>
						<span style={{opacity: opacity6}}>i</span>
						<span style={{opacity: opacity7}}>–what?</span>
					</Title>
				</div>
			</AbsoluteFill>
		</>
